            ...
            <section className="row">
                <div className="col-12 col-md-5 col-lg-3">
                    ...
                    <div className="text-center mt-2">
                        ...
                        <Button variant="info" onClick={() => setShowProfilePictureModal(true)}>
                ...
                <div className="col-12 col-md-7 col-lg-9 mt-4">
                    ...
                    <section>
                        <Button variant="info" onClick={(event) => navigate("/update-account")}>
                        ...
                        <Modal show={showDeleteAccountModal} onHide={() => setShowDeleteAccountModal(false)}>
                            ...
                            <Modal.Footer>
                                <Button variant="secondary" onClick={() => setShowDeleteAccountModal(false)}>Decline</Button>
