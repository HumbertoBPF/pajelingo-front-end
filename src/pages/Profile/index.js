        ...
        <>
            <section className="row">
                <div className="col-12 col-md-5 col-lg-3">
                    {(user)?
                    <img id="profilePicture" src={`data:image/jpeg;base64,${user.picture}`} className="img-fluid rounded" alt="User profile picture"/>:
                    <img id="defaultPicture" src="/images/profile.jpg" className="img-fluid rounded" alt="Default profile picture"/>}
                ...
                <div className="col-12 col-md-7 col-lg-9 mt-4">
                    ...
                    <section>
                        <Button id="updateAccountButton" colorStyle="info" type="button">
